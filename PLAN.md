Goal: Create a clean-professional-minimal firefox tab manager, with the following features:
...
- handle over 100 webpages

# Instructions

- Use skill to create an AGENT.md in this folder.
- Commit code in this folder.
- Write a README telling me how to install it.
- Use minimal code.

# Reference

Here's [my personal website](https://vincentqb.github.io/) as an example of web page style for optional inspiration.
